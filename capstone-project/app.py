...
def load_model():
    try:
        ...
        try:
            ...
            # If optimal model not found, try random forest model
        ...
        st.error("• model_obesitas_optimal.pkl ATAU random_forest_model.pkl")
        st.error("• scaler.pkl")
        st.info("💡 Upload file-file ini ke GitHub repository kamu.")
